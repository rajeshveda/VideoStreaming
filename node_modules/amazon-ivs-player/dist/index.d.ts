 ...
 * @hidden
 */
export declare interface AdCue extends Cue {
    /** Type of ad */
    rollType: 'preroll' | 'midroll' | 'postroll';
    /** Duration of the ad */
    duration: number;
...
declare interface MetadataPayloadMap {
    [MetadataEventType.ID3]: object;
    [MetadataEventType.CAPTION]: object;
}
...
declare interface Player {
    ...
    /**
     * For a live stream, the latency from the server to the player.
 ...
 */
export declare type PlayerEventMap = PlayerEventTypeMap & StatePayloadMap & MetadataPayloadMap & RemotePlayerMap;
 ...
 * @hidden
 */
export declare enum RemotePlayerEvent {
...
/**
 * Maps [[RemotePlayerEvent]] event names to their payload values.
 * All metadata events return `void`.
 * @hidden
 */
declare interface RemotePlayerMap {
    [RemotePlayerEvent.AVAILABLE]: void;
    [RemotePlayerEvent.UNAVAILABLE]: void;
    [RemotePlayerEvent.SESSION_STARTED]: string;
    [RemotePlayerEvent.SESSION_ENDED]: void;
}
...
/**
 * Signals the start of live content after an ad
 * @hidden
 */
export declare interface StreamSourceCue extends Cue {
