...
var Table = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  var _useState = (0, _react.useState)(isTree ? (0, _utils.flattenData)(dataProp) : dataProp),
      data = _useState[0],
      setData = _useState[1];
  ...
  var colCounts = (0, _react.useRef)((0, _flatten["default"])(children).length);
  ...
  (0, _utils.useUpdateEffect)(function () {
    setData(isTree ? (0, _utils.flattenData)(dataProp) : dataProp);
  }, [dataProp, isTree]);
  (0, _utils.useUpdateEffect)(function () {
    colCounts.current = (0, _flatten["default"])(children || []).length;
  }, [children]);
  ...
  var renderRow = function renderRow(props, cells, shouldRenderExpandedRow, rowData) {
    ...
    if (shouldFixedColumn && contentWidth.current > tableWidth.current) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_Row["default"], (0, _extends2["default"])({}, restRowProps, {
        "data-depth": depth,
        style: rowStyles
      }), fixedLeftCellGroupWidth ? /*#__PURE__*/_react["default"].createElement(_CellGroup["default"], {
        fixed: "left",
    ...
    return /*#__PURE__*/_react["default"].createElement(_Row["default"], (0, _extends2["default"])({}, restRowProps, {
      "data-depth": depth,
      style: rowStyles
    }), /*#__PURE__*/_react["default"].createElement(_CellGroup["default"], null, (0, _utils.mergeCells)(cells)), shouldRenderExpandedRow && renderRowExpanded(rowData));
  };
  ...
  var handleTreeToggle = (0, _react.useCallback)(function (rowKey, _rowIndex, rowData) {
    var open = false;
