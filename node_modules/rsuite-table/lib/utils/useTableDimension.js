...
var useTableDimension = function useTableDimension(props) {
  ...
  var calculateTableWidth = (0, _react.useCallback)(function () {
    var prevWidth = tableWidth.current;

    if (tableRef !== null && tableRef !== void 0 && tableRef.current) {
      var nextWidth = (0, _getWidth["default"])(tableRef === null || tableRef === void 0 ? void 0 : tableRef.current);
  ...
  (0, _useMount["default"])(function () {
    ...
    calculateTableWidth();
    setOffsetByAffix();
    (0, _elementResizeEvent["default"])(tableRef.current, (0, _debounce["default"])(calculateTableWidth, 400));
  });
  ...
  (0, _react.useEffect)(function () {
    return function () {
      if (tableRef.current) {
        ...
        (0, _elementResizeEvent.unbind)(tableRef.current);
      }
    }; // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);
